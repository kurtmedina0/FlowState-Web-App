...
function SignInModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div 
        className="relative w-full max-w-md animate-in zoom-in slide-in-from-bottom-4 duration-300"
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input 
                    type="checkbox" 
                    className="w-4 h-4 rounded border-slate-700 bg-slate-800 text-purple-500 focus:ring-purple-500/50 focus:ring-offset-0"
                  />
